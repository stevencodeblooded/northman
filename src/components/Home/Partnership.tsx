        ...
        <div>
          ...
          <div className="flex gap-6  flex-wrap justify-center">
            <div className="flex flex-col items-center gap-2">
              <FontAwesomeIcon icon={faHandshake} className="text-7xl text-cyan-950 " />
            ...
            <div className="flex flex-col items-center gap-2">
              <FontAwesomeIcon icon={faBusinessTime}  className="text-7xl text-cyan-950 " />
              <h2 className="font-medium text-lg text-cyan-950">Miguxian</h2>
            </div>
            <div className="hidden sm:block border-r-2 h- mx-10 border-green-950"></div>

            <div className="flex flex-col items-center gap-2">
              <FontAwesomeIcon icon={faScaleBalanced}  className="text-7xl text-cyan-950 " />
              <h2 className="font-medium text-lg text-cyan-950">Jeninayln</h2>
            </div>
            <div className="hidden sm:block border-r-2 h- mx-10 border-green-950"></div>

            <div className="flex flex-col items-center gap-2">
              <FontAwesomeIcon icon={faGavel}  className="text-7xl text-cyan-950 " />
